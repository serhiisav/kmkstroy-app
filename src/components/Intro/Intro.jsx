    ...
    return (
        ...
        >
            <div className={inViewport ? 'section-intro-wrap animate__animated animate__bounceInLeft animate__delay-0.5s' : 'section-intro-wrap-none'}>
                <h1 className="section-intro-title">{t('intro_title')}</h1>
                <p className="section-intro-subtitle">{t('intro_subtitle-p1')}</p>
                <p className="section-intro-subtitle">{t('intro_subtitle-p2')}</p>
            </div>
        </section>
    )
}
